...
var map_generator = function(parsedDataset){
  ...
  var draw = function(updateObject){
    ...
    var colorScale = d3.scale.linear()
        .domain([-250, 1000]) //use averagesExtent for relative color scaling
        .range(["red", "blue"]);

    var legendBlock = legend.append("rect")
                            .attr("width", 10)
                            .attr("height", 10)
                            .style("fill", colorScale(-250));
                            
    var legendBlock2 = legend.append("rect")
                            .attr("x", 10)
                            .attr("width", 10)
                            .attr("height", 10)
                            .style("fill", colorScale(0));
                            
    var legendBlock3 = legend.append("rect")
                            .attr("x", 20)
                            .attr("width", 10)
                            .attr("height", 10)
